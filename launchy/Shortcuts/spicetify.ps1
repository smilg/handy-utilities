# updates spicetify - needed each time Spotify updates. spicetify can be found here: https://github.com/khanhas/spicetify-cli

Invoke-WebRequest -UseBasicParsing "https://raw.githubusercontent.com/khanhas/spicetify-cli/master/install.ps1" | Invoke-Expression
spicetify config extensions dribbblish.js bookmark.js fullAppDisplay.js
